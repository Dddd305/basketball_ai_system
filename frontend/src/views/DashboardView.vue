...
const submitExactData = async () => {
  ...
  try {
    const response = await fetch(`'https://basketball-api-kyiv.onrender.comhttps://basketball-api-kyiv.onrender.com/api/users/${currentUserId}/calibrate`, {
      method: 'POST',
...
const saveProfile = async () => {
  try {
    const response = await fetch(`'https://basketball-api-kyiv.onrender.comhttps://basketball-api-kyiv.onrender.com/api/users/${currentUserId}`, {
...
const generatePlan = async () => {
  ...
  try {
    const response = await fetch(`https://basketball-api-kyiv.onrender.comhttps://basketball-api-kyiv.onrender.com/api/ai/generate_plan/${currentUserId}`, { method: 'POST' })
